...
[GeneratorBuilder(GenerationActionsKinds.ControllerMethods, typeof(CSharpLanguage))]
public class ControllerMethodsBuilder : GeneratorBuilderBase<CSharpGeneratorContext>
{
